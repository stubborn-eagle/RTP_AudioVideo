...
class JMFrame extends JInternalFrame implements ControllerListener {
	...
	if (ce instanceof RealizeCompleteEvent) {
	    ...
	    //Format[] inFormats = { new VideoFormat (VideoFormat.MPEG) };

//	    String JFFMPEG_VIDEO = "net.sourceforge.jffmpeg.VideoDecoder";
//	    Codec video=null;
//		try {
//			video = (Codec) Class.forName(JFFMPEG_VIDEO).newInstance();
...
//	    	   
        ...
        registeredPlugins1.addAll(PlugInManager.getPlugInList(null, null, PlugInManager.CODEC));
         for (String string : registeredPlugins1) {
        	 //if(string.toLowerCase().contains("mov"))
                       System.out.println("registeredPlugins1 : " + string);
          }
